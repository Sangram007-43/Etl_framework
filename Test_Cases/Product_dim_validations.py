...
logger = Logs.Log_Gen(f'C:\\Users\\Sangram\\PycharmProjects\\Configdrivenapproach\\Logs\\product_dim_{dt}.log')

with open(r'C:\Users\Sangram\PycharmProjects\Configdrivenapproach\Config\SQL_Queries_config\Product_dim.json','r') as Product_data_SQL_fle:
...
dt = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
output_file_path = f"C:\\Users\\Sangram\\PycharmProjects\\Configdrivenapproach\\Output_Result\\Product_dim_Result_{dt}.xlsx"
