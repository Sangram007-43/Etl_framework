...
logger = Logs.Log_Gen(f'C:\\Users\\Sangram\\PycharmProjects\\Configdrivenapproach\\Logs\\Table_existence_{dt}.log')

with open(r'C:\Users\Sangram\PycharmProjects\Configdrivenapproach\Config\SQL_Queries_config\Tables_Checking.json','r') as Tables_chk_file:
     table_list = json.load(Tables_chk_file)

with open(r'C:\Users\Sangram\PycharmProjects\Configdrivenapproach\Config\SQL_Queries_config\Tables_Existence_Validation.json','r') as Data_Validation_file:
...
dt = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
output_path = f"C:\\Users\\Sangram\\PycharmProjects\\Configdrivenapproach\\Output_Result\\Table_existence_validation_{dt}.xlsx"
